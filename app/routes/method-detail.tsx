...
export default function MethodDetail() {
  ...
  const methodType =
    id?.includes("express") || id?.includes("marzocco")
      ? "espresso"
      : id === "french-press"
      ? "immersion"
      : id === "aeropress"
  ...
  const methodAdvice: Record<string, string> = {
    chemex:
      "Use a medium-coarse grind and always pre-wet the filter to remove paper taste. The thick filter creates a clean, bright cup.",
    v60: "Use a medium-fine grind and a steady pour with a gooseneck kettle for even extraction.",
    aeropress:
      "Versatile brewer that can use various grind sizes. Standard or inverted methods both work well.",
    "french-press":
      "Use a coarse grind to prevent sediment and allow at least 4 minutes of brewing time.",
    "barista-express":
      "Warm up machine for at least 20 minutes before use. Use freshly roasted beans for best results.",
    "la-marzocco":
      "Professional-grade espresso machine that requires precise dial-in. Excellent temperature stability.",
  };
          ...
          <div>
            <div className="border border-muted rounded-sm overflow-hidden bg-card mb-8">
              <div className="bg-card border-b border-muted p-4">
                <h2 className="text-lg font-mono font-semibold text-primary flex items-center gap-2">
                  <span className="text-accent">cat</span> {methodName}
                  /README.md
                </h2>
              </div>
              <div className="p-5">
                ...
                <h3 className="text-md font-medium text-accent mb-4 font-mono">
                  // General Parameters
                </h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6 font-mono">
                  ...
                  <div className="border border-muted/50 p-3 rounded-sm bg-background/40">
                    ...
                    <p>{methodType === "espresso" ? "90-94°C" : "90-96°C"}</p>
                  </div>
                ...
                <div className="border border-muted rounded-sm p-4 font-mono bg-background/40">
                  <h3 className="text-md font-medium text-accent mb-3">
                    /** * Unofficial Terminal Tips for {methodName}
                    */
                  </h3>
                  <ul className="pl-5 space-y-3 text-sm list-none">
                    {methodType === "espresso" && (
                      <>
                        <li>
                          <span className="text-primary">1.</span> Always warm
                          up your machine and portafilter thoroughly.
                        </li>
                        <li>
                          <span className="text-primary">2.</span> Use a
                          distribution tool for even extraction.
                        </li>
                        <li>
                          <span className="text-primary">3.</span> Purge the
                          group head before attaching the portafilter.
                        </li>
                        <li>
                          <span className="text-primary">4.</span> Clean your
                          machine regularly to prevent flavor contamination.
                        </li>
                      </>
                    )}
                    ...
                    {methodType === "filter" && (
                      <>
                        <li>
                          <span className="text-primary">1.</span> Always use a
                          gooseneck kettle for precise pouring.
                        </li>
                        <li>
                          <span className="text-primary">2.</span> Pre-wet the
                          filter to remove paper taste.
                        </li>
                        <li>
                          <span className="text-primary">3.</span> Start with a
                          bloom phase (30-45 seconds) to degas the coffee.
                        </li>
                        <li>
                          <span className="text-primary">4.</span> Pour in
                          concentric circles to ensure even extraction.
                        </li>
                      </>
                    )}
                    ...
                    {methodType === "immersion" && (
                      <>
                        <li>
                          <span className="text-primary">1.</span> Preheat your
                          brewing vessel with hot water.
                        </li>
                        <li>
                          <span className="text-primary">2.</span> Stir gently
                          after adding coffee to ensure all grounds are
                          saturated.
                        </li>
                        <li>
                          <span className="text-primary">3.</span> Use a timer
                          to achieve consistent results.
                        </li>
                        <li>
                          <span className="text-primary">4.</span> Press the
                          plunger slowly to minimize sediment.
                        </li>
                      </>
                    )}
                    ...
                    {methodType === "hybrid" && (
                      <>
                        <li>
                          <span className="text-primary">1.</span> Experiment
                          with both standard and inverted methods.
                        </li>
                        <li>
                          <span className="text-primary">2.</span> Try different
                          water temperatures for different flavor profiles.
                        </li>
                        <li>
                          <span className="text-primary">3.</span> Press with
                          steady, gentle pressure.
                        </li>
                        <li>
                          <span className="text-primary">4.</span> Clean the
                          rubber seal regularly for better extraction.
                        </li>
                      </>
                    )}
                  </ul>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {coffeesWithRecipes.map(({ coffee, recipe }) => {
                ...
                return (
                  <AccordionItem key={recipe.id} value={coffee.id}>
                    <AccordionTrigger className="font-mono">
                      <div className="flex items-center gap-2">
                        <h3 className="text-lg font-semibold">{coffee.name}</h3>
                        <div className="flex items-center gap-1 ml-3">
                          <span className="px-2 py-0.5 bg-accent/20 text-accent text-xs font-mono rounded-sm">
                            {recipe.parameters.grindSize}
                          </span>
                          <span className="px-2 py-0.5 bg-primary/20 text-primary text-xs font-mono rounded-sm">
                            {recipe.parameters.dose}
                          </span>
                          <span className="px-2 py-0.5 bg-secondary/20 text-secondary-foreground text-xs font-mono rounded-sm">
                            {coffee.type}
                          </span>
                        </div>
                      </div>
                    ...
                    <AccordionContent>
                      <div className="grid sm:grid-cols-2 gap-6">
                        <div>
                          ...
                          <div className="mb-2">
                            <h4 className="text-sm text-primary font-medium mb-1">
                              Flavor Notes
                            </h4>
