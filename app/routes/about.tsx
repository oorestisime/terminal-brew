    ...
    <Layout>
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold text-primary mb-6">
          About Terminal Brew Guide
        </h1>

        <div className="space-y-6 prose text-foreground">
          <p>
            Terminal Brew Guide is an open-source collection of coffee brewing
            recipes specifically for coffees sold on{" "}
            <a
          ...
          <p>
            This project is open source and contributions are welcome! If you'd
            like to add:
          </p>
          ...
          <p className="mt-4">
            ...
            <a
              href="https://github.com/oorestisime/terminal-brew"
              target="_blank"
              rel="noopener noreferrer"
              className="text-primary hover:underline"
            >
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              <a
                href="https://github.com/oorestisime/terminal-brew/issues"
                target="_blank"
                rel="noopener noreferrer"
                className="text-primary hover:underline"
              >
